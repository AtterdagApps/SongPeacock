...
//    ]))
    static let iWantItThatWay = SongInfo(artist: "Backstreet Boys", title: "I Want It That Way", lyrics: .init(sentences: [
        .init(text: "Yeah", timestamp: 3.5455009937286373),
        .init(text: "You are my fire", timestamp: 8.961747169494629),
        .init(text: "The one desire", timestamp: 14.382716178894043),
        .init(text: "Believe when I say", timestamp: 19.26618504524231),
        .init(text: "I want it that way", timestamp: 24.115226984024048),
        .init(text: "But we are two worlds apart", timestamp: 28.768802165985107),
        .init(text: "Can't reach to your heart when you say", timestamp: 35.45344805717468),
//        .init(text: "When you say", timestamp: 40.38674592971801),
        .init(text: "That I want it that way", timestamp: 43.47192716598511),
        .init(text: "Tell me why", timestamp: 48.25499486923218),
        .init(text: "Ain't nothin' but a heartache", timestamp: 49.82286500930786),
        .init(text: "Tell me why", timestamp: 52.87532901763916),
        .init(text: "Ain't nothin' but a mistake", timestamp: 54.80985498428345),
        .init(text: "Tell me why I never wanna hear you say", timestamp: 58.029069900512695),
        .init(text: "I want it that way", timestamp: 63.049903869628906),
